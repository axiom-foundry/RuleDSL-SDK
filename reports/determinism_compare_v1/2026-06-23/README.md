# Determinism comparison reports — 2026-06-23

This directory holds the **cross-platform comparison reports** for the published
determinism evidence set dated `2026-06-23`. Each report records a Windows-x64 vs
...
[`reports/determinism_v1_0/2026-06-23/`](../../determinism_v1_0/2026-06-23/). Each bundle
holds `inputs/`, `outputs/`, an `environment/` fingerprint, a `manifest.json`, and a
`SHA256SUMS.txt`:

| Bundle directory | Platform | DET case |
| --- | --- | --- |
| `reports/determinism_v1_0/2026-06-23/windows-x64/ci-windows/` | Windows-x64 | DET-001 |
| `reports/determinism_v1_0/2026-06-23/linux-x64/ci-linux/` | Linux-x64 | DET-001 |
| `reports/determinism_v1_0/2026-06-23/windows-x64/ci-windows-det003/` | Windows-x64 | DET-003 |
| `reports/determinism_v1_0/2026-06-23/linux-x64/ci-linux-det003/` | Linux-x64 | DET-003 |
...
`reports/determinism_v1_0/2026-06-23/linux-x64/ci-linux[-det003]/` — its
...
sha256sum reports/determinism_v1_0/2026-06-23/linux-x64/ci-linux/outputs/DET-001_output.bin
sha256sum reports/determinism_v1_0/2026-06-23/windows-x64/ci-windows/outputs/DET-001_output.bin
# both MUST equal f3714ba24ad7a84218874bff096eab721bd67bcd5641cd45d2973fd86d55c5e1

# DET-003 — deterministic error path
sha256sum reports/determinism_v1_0/2026-06-23/linux-x64/ci-linux-det003/outputs/DET-003_output.bin
sha256sum reports/determinism_v1_0/2026-06-23/windows-x64/ci-windows-det003/outputs/DET-003_output.bin
...
```sh
( cd reports/determinism_v1_0/2026-06-23/linux-x64/ci-linux        && sha256sum -c SHA256SUMS.txt )
( cd reports/determinism_v1_0/2026-06-23/linux-x64/ci-linux-det003 && sha256sum -c SHA256SUMS.txt )
( cd reports/determinism_v1_0/2026-06-23/windows-x64/ci-windows        && sha256sum -c SHA256SUMS.txt )
( cd reports/determinism_v1_0/2026-06-23/windows-x64/ci-windows-det003 && sha256sum -c SHA256SUMS.txt )
```
