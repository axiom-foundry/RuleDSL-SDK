...
- Cross-platform reproducibility for DET-003 is demonstrated by a **published comparison** of independent Windows-x64 and Linux-x64 CI runs: the error-path output bytes are byte-identical (`status: pass`, `equal_output: true`). See [`reports/determinism_compare_v1/2026-06-21/DET-003/windows-x64__linux-x64/comparison.json`](../../reports/determinism_compare_v1/2026-06-21/DET-003/windows-x64__linux-x64/comparison.json). Independent multi-host reproducibility remains future work.
