...
- Cross-platform reproducibility for DET-001 is demonstrated by a **published comparison** of independent Windows-x64 (`windows-2022`) and Linux-x64 (`ubuntu-24.04`) CI runs: the decision-output bytes are byte-identical (`status: pass`, `equal_output: true`). See [`reports/determinism_compare_v1/2026-06-21/DET-001/windows-x64__linux-x64/comparison.json`](../../reports/determinism_compare_v1/2026-06-21/DET-001/windows-x64__linux-x64/comparison.json) and the source bundles under [`reports/determinism_v1_0/2026-06-21/`](../../reports/determinism_v1_0/2026-06-21/). A first committed same-platform machine reproduction is **published 2026-07-14**: a fresh Windows-x64 desktop reproduced the DET-001 golden decision output byte-for-byte — see [`reports/cross_machine_replay_v1/2026-07-14/`](../../reports/cross_machine_replay_v1/2026-07-14/). Broader multi-host and independent third-party reproduction remain open.
...
- Cross-platform reproducibility for DET-003 is demonstrated by a **published comparison** of independent Windows-x64 and Linux-x64 CI runs: the error-path output bytes are byte-identical (`status: pass`, `equal_output: true`). See [`reports/determinism_compare_v1/2026-06-21/DET-003/windows-x64__linux-x64/comparison.json`](../../reports/determinism_compare_v1/2026-06-21/DET-003/windows-x64__linux-x64/comparison.json). A first committed same-platform machine reproduction is **published 2026-07-14**: a fresh Windows-x64 desktop reproduced the DET-003 golden error-path output byte-for-byte — see [`reports/cross_machine_replay_v1/2026-07-14/`](../../reports/cross_machine_replay_v1/2026-07-14/). Broader multi-host and independent third-party reproduction remain open.
